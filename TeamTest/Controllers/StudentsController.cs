...
namespace TeamTest.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var students = db.Students.Include(s => s.ApplicationUser);
        ...
        public ActionResult Details(string id)
        {
            ...
            //var courses = db.Courses.Where(p => p.Students.Any(c=>c.StudentId == id)).ToList();
            var courses = st.Courses.ToList();
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName")] Student student)
        {
            ...
            ViewBag.StudentId = new SelectList(db.Users, "Id", "Email", student.StudentId);
            return View(student);
        }
